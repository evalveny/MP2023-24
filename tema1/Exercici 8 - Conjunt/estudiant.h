...
ostream& operator<<(ostream& output, const Estudiant& Conjunt);
ofstream& operator<<(ofstream& output, const Estudiant& Conjunt);
ifstream& operator>>(ifstream& input, Estudiant& Conjunt);
